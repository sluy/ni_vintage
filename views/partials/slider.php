  ...
  <div class="ls-slide" data-ls="kenburnsscale:1.2;">
    <?php
      ...
      foreach ($ctx['service']->image_posts as $current) {
        $imagePostCounter++;
        $imageDelay = 100 + ($multiplierCounter * 400);
        if ($multiplierCounter === 0) {
          $imageDelay = 0;
        } else if ($multiplierCounter === 1) {
          $imageDelay = 100;
        }
        $multiplierCounter++;
    ...
    <img data-delay="<?php echo $imageDelay;?>" data-post-id="<?php echo $multiplierCounter;?>"
      data-round-id="<?php echo $imagePostCounter;?>" width="<?php echo $current->width;?>"
      height="<?php echo $current->height;?>" src="<?php echo url('compress?src=' . $current->src);?>" class="ls-l"
      alt=""
